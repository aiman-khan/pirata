...
import '../../controllers/home_calendar_controller.dart';
import '../store_details.dart';
import '../visit_details.dart';
import 'home_chat.dart';
import 'home_map.dart';

class HomeCalender extends GetView<HomeCalendarController> {
  @override
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                              ...
                              child: StreamBuilder<QuerySnapshot>(
                                  stream: controller.storesRef.snapshots(),
