        ...
        children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("NOMBRE TIENDA", style: TextStyle(fontSize: size.width * 0.05,fontWeight: FontWeight.bold),),
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Última visita - 10/01/23",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04),),
                Row(
                  children: const [
                    Icon(Icons.star),
                    Icon(Icons.star),
                    ...
                    children: [
                      ListTile(
                        title: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Palomitas amaranto, linaza",style: TextStyle(fontSize: size.width * 0.04,fontWeight: FontWeight.bold),),
                            Text("SKU 15364667",style: TextStyle(fontSize: size.width * 0.04)),
                            Text("28 Bolsas",style: TextStyle(fontSize: size.width * 0.035)),
                          ],
                        ),
