...
class StoreNamePart3 extends StatefulWidget {
  const StoreNamePart3({Key? key}) : super(key: key);

  @override
  State createState() => _StoreNamePart3State();
}
      ...
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Text("finalizar".toUpperCase(),textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04,color: Colors.white,fontWeight: FontWeight.w600),),
          ),
        ),
      ),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: size.height * 0.02,),
                  Text("PASO 3: CALIFICACIÓN", style: TextStyle(fontSize: size.width * 0.05, fontWeight: FontWeight.bold),),
                  SizedBox(height: size.height * 0.02,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
            ...
            Padding(
              padding: EdgeInsets.all(size.width * 0.04),
              child: Text("Tu opinión es muy importante.\nResponde lo más honesto posible.",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04),),
            ),
            const Divider(color: Color(0xffCFCFCF),),
            SizedBox(height: size.height * 0.02,),
            Text("Disponibilidad",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04,fontWeight: FontWeight.bold),),
            SizedBox(height: size.height * 0.01,),
            RatingBar.builder(
            initialRating: 3,
            minRating: 1,
            ...
            Text("Amabilidad",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04,fontWeight: FontWeight.bold),),
            SizedBox(height: size.height * 0.01,),
            RatingBar.builder(
              initialRating: 5,
              minRating: 1,
            ...
            SizedBox(height: size.height * 0.04,),
            Text("Limpieza",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04,fontWeight: FontWeight.bold),),
            SizedBox(height: size.height * 0.01,),
            RatingBar.builder(
              initialRating: 1,
              minRating: 1,
            ...
            SizedBox(height: size.height * 0.04,),
            Text("Normas de seguridad",textAlign: TextAlign.center, style: TextStyle(fontSize: size.width * 0.04,fontWeight: FontWeight.bold),),
            SizedBox(height: size.height * 0.01,),
            RatingBar.builder(
              initialRating: 4,
              minRating: 1,
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Gerente presente", style: TextStyle(fontSize: size.width * 0.035),),
                  CupertinoSwitch(
